    ...
    while (true) {
      ...
      switch (opcao) {
        case 1: // Adicionar Contato
          ...
          break;
        case 2: // Remover Contato pelo nome
          System.out.print("Nome do contato a ser removido: ");
          String nomeDigitado = scanner.nextLine();
          boolean removido = agenda.remove(nomeDigitado);
          if (removido) {
        ...
        case 3: // Buscar contato
          System.out.print(
            "Digite o nome, telefone ou email do contato a ser buscado: "
          );
